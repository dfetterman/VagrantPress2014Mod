...
/** dane added - local config forced */
$wpLocation = "http://" . $_SERVER[ 'HTTP_HOST' ] . "";
...
define('DB_NAME', 'dbnameVAR');

/** MySQL database username */
define('DB_USER', 'dbuserVAR');

/** MySQL database password */
define('DB_PASSWORD', 'dbpasswdVAR');

/** MySQL hostname */
define('DB_HOST', 'dbhostVAR');
